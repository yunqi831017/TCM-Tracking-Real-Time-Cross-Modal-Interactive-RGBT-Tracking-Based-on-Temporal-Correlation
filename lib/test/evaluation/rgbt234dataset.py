...
class rgbt234Dataset(BaseDataset):
    ...
    def __init__(self, split):
        ...
        if split == 'rgbt234' or split == 'val':
            self.base_path = os.path.join(self.env_settings.rgbt234_path, split)
        else:
            self.base_path = os.path.join(self.env_settings.rgbt234_path, 'train')

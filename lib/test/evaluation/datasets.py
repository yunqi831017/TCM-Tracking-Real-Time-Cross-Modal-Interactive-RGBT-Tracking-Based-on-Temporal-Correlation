...
dataset_dict = dict(
    ...
    gtot_test=DatasetInfo(module=pt % "gtot", class_name="gtotDataset", kwargs=dict(split='gtot')),
    rgbt234_test=DatasetInfo(module=pt % "rgbt234", class_name="rgbt234Dataset", kwargs=dict(split='rgbt234')),
    hial_test=DatasetInfo(module=pt % "HiAl", class_name="HiAlDataset", kwargs=dict(split='HiAl')),
    vtuav_test=DatasetInfo(module=pt % "vtuav", class_name="vtuavDataset", kwargs=dict(split='test短')),
)

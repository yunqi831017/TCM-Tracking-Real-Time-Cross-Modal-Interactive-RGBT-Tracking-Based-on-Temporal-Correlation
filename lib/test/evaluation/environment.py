...
class EnvSettings:
    def __init__(self):
        ...
        self.davis_dir = ''
        self.youtubevos_dir = ''
        self.lasher_path ='/home/zyh/桌面/data/lasher/'
        self.gtot_path = '/home/zyh/桌面/data/'
        self.rgbt234_path = '/home/zyh/桌面/data/'
        self.HiAl_path = '/media/zyh/云祈/datasets/HiAl/'
        self.VTUAV_path = '/home/zyh/桌面/data/VTUAV/'
